...
def get_model_path(window_length, predictor_type, use_batch_norm):
    ...
    return 'weights/cryptocurrency/{}/window_{}/{}/checkpoint.ckpt'.format(predictor_type, window_length, batch_norm_str)
...
def get_result_path(window_length, predictor_type, use_batch_norm):
    if use_batch_norm:
        ...
        batch_norm_str = 'no_batch_norm'
    return 'results/cryptocurrency/{}/window_{}/{}/'.format(predictor_type, window_length, batch_norm_str)
...
if __name__ == '__main__':
    ...
    # setup environment
    env = PortfolioEnv(config, is_training)
